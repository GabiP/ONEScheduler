...
public class FairshareFactory {
    ...
    public static List<AbstractPriorityCalculator> getFairshares(String[] stringfairshares) {
        List<AbstractPriorityCalculator> fairshares = new ArrayList<>();
        for (int i = 0; i < stringfairshares.length; i++) {
            ...
            AbstractPriorityCalculator f = FairshareFactory.createFairshare(fairshareString);
            fairshares.add(f);
        }
        return fairshares;
    }
